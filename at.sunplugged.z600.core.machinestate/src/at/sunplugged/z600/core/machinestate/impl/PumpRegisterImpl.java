...
import at.sunplugged.z600.core.machinestate.impl.pumps.CryoPumpOne;
import at.sunplugged.z600.core.machinestate.impl.pumps.CryoPumpTwo;
...
public class PumpRegisterImpl implements PumpRegistry {
    ...
    public PumpRegisterImpl(MachineStateService machineStateService) {
        ...
        pumpMap.put(PumpIds.CRYO_ONE, new CryoPumpOne(machineStateService));
        pumpMap.put(PumpIds.CRYO_TWO, new CryoPumpTwo(machineStateService));
    }
