 ...
 * measurement values. By that the interface provides access to all values of the machine.
 * 
...
public interface MachineStateService {
    ...
    /**
     * Updates the current state of the machine (i. e. Outlets, Measurement Values and so on).
     * Measurements are automatically saved in the {@linkplain DataService}.
     * 
     * @param Date snapShotdate date of the data acquisition
     */
     ...
     * 
     * @param at which point in the machine.
