...
public class WagoAddresses {
                                ...
                                24), PRE_PUMP_ROOTS(25), TUROBO_PUMP(26), PRE_PUMP_TWO(27), COMPRESSOR_ONE(
                                        28), COMPRESSOR_TWO(29), WATER_TURBO_PUMP(31), WATER_KATH_ONE(
                                                32), WATER_KATH_TWO(33), WATER_KATH_THREE(34), OUTLET_NINE(
                                                        35), WATER_SHIELD(36), WATERPUMP(37), SSV_TWO_START(
                                                                39), SSV_ONE_START(40), PINNACLE_REG_ONE(
    ...
    public enum DigitalInput {
        ...
        OUTLET_ONE_CLOSED(0), OUTLET_TWO_CLOSED(3), OUTLET_THREE_OPEN(4), PRESSURE_FOR_OUTLETS(
                6), CONVEYOR_LIGHT_SWITCH_RIGHT_FRONT(8), CONVEYOR_LIGHT_SWITCH_RIGHT_BACK(
                        9), CONVEYOR_LIGHT_SWITCH_LEFT_BACK(10), CONVEYOR_LIGHT_SWITCH_LEFT_FRONT(11), PRE_PUMP_ONE_OK(
                                12), PRE_PUMP_ROOTS_OK(13), TURBO_PUMP_OK(14), TURBO_PUMP_HIGH_SPEED(
                                        15), PRE_PUMP_TWO_OK(16), COMPRESSOR_ONE_OK(17), COMPRESSOR_TWO_OK(
                                                18), CRYO_ONE_LOW(20), CRYO_TWO_LOW(22), WATER_KATH_ONE_ON(
                                                        23), WATER_KATH_TWO_ON(24), WATER_KATH_THREE_ON(
                                                                25), WATER_KATH_FOUR_ON(
                                                                        26), CONVEYOR_LIMIT_SWITCH_RIGHT_BACK(
                                                                                32), CONVEYOR_LIMIT_SWITCH_RIGHT_FRONT(
                                                                                        33), PINNACLE_OUT(
                                                                                                34), CONVEYOR_LIMIT_SWITCH_LEFT_FRONT(
                                                                                                        35), CONVEYOR_LIMIT_SWITCH_LEFT_BACK(
                                                                                                                36), P_120_MBAR(
                                                                                                                        38), LEFT_SPEED_TRIGGER(
                                                                                                                                39), RIGHT_SPEED_TRIGGER(
                                                                                                                                        40), COOLING_PUMP_OK(
                                                                                                                                                41), SSV_TWO_ERROR(
                                                                                                                                                        42), SSV_ONE_ERROR(
                                                                                                                                                                43);
    ...
    public enum AnalogInput {
        VOLTAGE_SSV_TWO(0), CURRENT_SSV_TWO(1), GAS_FLOW(2), PREASURE_TURBO_PUMP(3), CONVEYOR_POSITION_L_R(
                4), PREASURE_CRYO_ONE(5), PREASURE_CRYO_TWO(6), VOLTAGE_PINNACLE(
                        7), POWER_PINNACLE(8), PREASURE_CHAMBER(9), VOLTAGE_SVV_ONE(10), CURRENT_SVV_ONE(11);
