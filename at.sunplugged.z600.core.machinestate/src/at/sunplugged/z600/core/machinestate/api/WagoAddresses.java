...
public class WagoAddresses {
    ...
    public enum DigitalOutput {
        ...
        OUTLET_SIX(4),
        OUTLET_FOUR(5),
        BELT_RIGHT_FORWARD_MOV(8),
        BELT_RIGHT_BACKWARDS_MOV(9),
        BELT_LEFT_FORWARD_MOV(10),
        BELT_LEFT_BACKWARDS_MOV(11),
        SUPPLY_CONVEYOR_MEASURMENT(16),
        PRE_PUMP_ONE(24),
        PRE_PUMP_ROOTS(25),
        TUROBO_PUMP(26),
        PRE_PUMP_TWO(27),
    ...
    public enum DigitalInput {
        ...
        OUTLET_TWO_CLOSED(3),
        OUTLET_THREE_OPEN(4),
        PRESSURE_FOR_OUTLETS(6),
        CONVEYOR_LIGHT_SWITCH_RIGHT_FRONT(8),
        CONVEYOR_LIGHT_SWITCH_RIGHT_BACK(9),
        CONVEYOR_LIGHT_SWITCH_LEFT_BACK(10),
        CONVEYOR_LIGHT_SWITCH_LEFT_FRONT(11),
        PRE_PUMP_ONE_OK(12),
        ...
        CONVEYOR_LIMIT_SWITCH_LEFT_FRONT(32),
        CONVEYOR_LIMIT_SWITCH_LEFT_BACK(33),
        PINNACLE_OUT(34),
        CONVEYOR_LIMIT_SWITCH_RIGHT_BACK(35),
        CONVEYOR_LIMIT_SWITCH_RIGHT_FRONT(36),
        P_120_MBAR(38),
