...
/**
 * This service provides an interface to save data and retrieve it again. It
 * also allows a connection to an SQL server to save the data manually or
 * automatically. This is a singleton service (i. e. every service instance
 * provides access to the same database).
 * 
 * 
...
public interface DataService {
     ...
     * @deprecated
     * 
     *             This Method is only temporary for adding the SRM data to an
     *             existing table.
     */
