...
/**
 * Provides the interface between the frontend and the backend. All commands
 * from the frontend should use one of the functions defined here.
 * 
...
public interface ControllerInterface {
    ...
    public enum MachineState {
        ...
        STARTING(),
        CREATING_PRE_VAKUUM(),
        CREATING_VAKUUM_FOR_TMP(),
        CREATING_FINAL_VAKUUM(),
        CLEARING_CRYO_PUMPS(),
        STARTING_KATHODES(),
        PROCESS_RUNNING,
        SHUTTING_DOWN();
    ...
    /**
     * This Method is only temporary. It allows for the logging of the SRM Data
     * to an existing SQL Table. The Table will be chosen automatically.
     * 
     * @deprecated
     * @param hostname
     *            of the SQL Server.
